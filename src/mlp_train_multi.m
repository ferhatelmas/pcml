function [hw_l_1, hw_r_1, hb_l_1, hb_r_1, hw_l_2, hw_r_2, hw_lr_2, hb_l_2, hb_r_2, hb_lr_2, hw_3, hb_3, tr_err, val_err, zero_one_error] = mlp_train_multi(X_L, X_R, T, X_L_val, X_R_val, T_val, h1, h2, nu, mu, batch_size)
%MLP_TRAIN_MULTI(X_L, X_R, T, X_L_val, X_R_val, T_val, h1, h2, nu, mu, batch_size)
...
while(sum(early_stop > 1e-8*ones(1,2)) > 0) 
    ...
    for i=1:batch_size:n
        ...
        [dw_l_1, dw_r_1, ...
         ...
         r_l_1, r_r_1, ...
         r_l_2, r_r_2, r_lr_2, ...
         r_3] = mlp_backward_multi(x_l, x_r, t, ...
                                   a_l_1, a_r_1, ...
                                   a_l_2, a_r_2, a_lr_2, ...
                                   a_3, ...
                                   z_l_1, z_r_1, ...
