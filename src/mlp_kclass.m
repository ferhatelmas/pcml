function [tr_err, val_err, zero_one_error, sq_error_test, confused] = mlp_kclass(h1, h2, nu, mu, batch_size)
...
% Runs mlp_multi to get optimum weights and biases
[w_l_1, w_r_1, b_l_1, b_r_1, ...
 w_l_2, w_r_2, w_lr_2, b_l_2, b_r_2, b_lr_2, ...
 w_3, b_3, tr_err, val_err, zero_one_error] = mlp_multi(X_L, X_R, T, X_L_val, X_R_val, T_val, h1, h2, nu, mu, batch_size);
